...
## Purpose
Provides a focused maintenance operation for the **Windows_Security_Check** workflow.
...
![Windows_Security_Check Screenshot Placeholder](../../assets/Windows_Security_Check.png)
